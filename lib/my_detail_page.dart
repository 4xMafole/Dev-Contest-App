import 'dart:convert';
import 'package:dev_contest/detail_controller.dart';
...
class _DetailPageState extends State<DetailPage> {
  List participants = [];
  final DetailController favController = Get.put(DetailController());
  ...
  _readData() async {
    await DefaultAssetBundle.of(context)
        ...
        .then((value) {
      setState(() {
        participants = json.decode(value);
      });
    });
  }
                  ...
                  child: Container(
                    decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                            image: AssetImage(participants[i]['img']),
                            fit: BoxFit.cover)),
                  ),
                )
            ]),
                ...
                child: Row(
                  children: [
                    Container(
                      ...
                      child: IconButton(
                        onPressed: () => favController.favCounter(),
                        icon: Icon(
